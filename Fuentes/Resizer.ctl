...
'because my control uses some data types defined in the comctlLib!!!
...
Private Sub UserControl_Show()
    ...
    If Not m_ControlVisible(0) Then
        ...
        If TypeOf cnt(1 - i) Is ComctlLib.ListView Then
    ...
    Else
        ...
        Case ccOrientationHorizontal
            ...
            If TypeOf cnt(0) Is ComctlLib.ListView Then
            ...
            Else
                ...
                h = cnt(0).Height
            End If
            If TypeOf cnt(1) Is ComctlLib.ListView Then
...
Public Property Let BorderStyle(ByVal New_BorderStyle As ComctlLib.BorderStyleConstants)
...
Public Property Get Appearance() As ComctlLib.AppearanceConstants
    Appearance = UserControl.Appearance
End Property

Public Property Let Appearance(ByVal New_Appearance As ComctlLib.AppearanceConstants)
